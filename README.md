...
For more information, visit the model page on [Hugging Face](https://huggingface.co/sshleifer/distilbart-cnn-12-6).
...
- Ensure you have CUDA enabled GPU for training the model, The trained model was trained on nvidia RTX 2060 ,6GB Memory and it wass limited to only ingesting 80 txt files which was a small amount of training data as opposed to the 849.txt's data extracted [here](https://drive.google.com/drive/folders/1-9ZIljXGrGP-_qt_exlRQ214woQ7nk0N?usp=sharing).
